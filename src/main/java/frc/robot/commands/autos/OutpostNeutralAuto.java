    ...
    public AutoRoutine simplePathAuto() {
        ...
        pickup.done().onTrue(Commands.parallel(
         ...
         shooting.done().onTrue(Commands.sequence(
                ...
                new InstantCommand(() -> RobotContainer.drivetrain.applyRequest(Controls.localHeading(Robot.alliance == Alliance.Red ? Constants.FieldConst.RED_HUB : Constants.FieldConst.BLUE_HUB))),
